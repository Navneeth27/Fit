...
#import <AWSiOSSDKv2/AWSKinesisModel.h>
 ...
 *
 * @return An instance of BFTask. On successful execution, task.result will be nil. On failed execution, task.error may contain an NSError with AWSKinesisErrorDomain domian and the following error code: AWSKinesisErrorResourceInUse, AWSKinesisErrorLimitExceeded, AWSKinesisErrorInvalidArgument.
 *
 ...
 *
 * @return An instance of BFTask. On successful execution, task.result will be nil. On failed execution, task.error may contain an NSError with AWSKinesisErrorDomain domian and the following error code: AWSKinesisErrorResourceNotFound, AWSKinesisErrorLimitExceeded.
 *
 ...
 *
 * @return An instance of BFTask. On successful execution, task.result will contain an instance of AWSKinesisDescribeStreamOutput. On failed execution, task.error may contain an NSError with AWSKinesisErrorDomain domian and the following error code: AWSKinesisErrorResourceNotFound, AWSKinesisErrorLimitExceeded.
 *
 ...
 *
 * @return An instance of BFTask. On successful execution, task.result will contain an instance of AWSKinesisGetShardIteratorOutput. On failed execution, task.error may contain an NSError with AWSKinesisErrorDomain domian and the following error code: AWSKinesisErrorResourceNotFound, AWSKinesisErrorInvalidArgument, AWSKinesisErrorProvisionedThroughputExceeded.
 *
 ...
 *
 * @return An instance of BFTask. On successful execution, task.result will contain an instance of AWSKinesisListStreamsOutput. On failed execution, task.error may contain an NSError with AWSKinesisErrorDomain domian and the following error code: AWSKinesisErrorLimitExceeded.
 *
 ...
 *
 * @return An instance of BFTask. On successful execution, task.result will contain an instance of AWSKinesisListTagsForStreamOutput. On failed execution, task.error may contain an NSError with AWSKinesisErrorDomain domian and the following error code: AWSKinesisErrorResourceNotFound, AWSKinesisErrorInvalidArgument, AWSKinesisErrorLimitExceeded.
 *
